...
const PixelCopyrightIcon = () => (
  <svg className="footer-pixel-copyright-icon" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
...
const GhIconLink = () => (
  <a
    className="header-footer-icon-button icon-button"
  ...
  return (
    <footer className="footer-container">
      <div className="copyright-content">
        <PixelCopyrightIcon />
        <p className="footer-copyright-year">2024</p>
        <p className="footer-author-name">Nolan Gajdascz</p>
      </div>
      <GhIconLink />
    </footer>
  );
